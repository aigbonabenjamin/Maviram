...
// Better Auth tables
export const betterAuthUser = mysqlTable('better_auth_user', {
...
export const betterAuthSession = mysqlTable('better_auth_session', {
  id: text('id').primaryKey(),
...
export const betterAuthAccount = mysqlTable('better_auth_account', {
  id: text('id').primaryKey(),
...
export const betterAuthVerification = mysqlTable('better_auth_verification', {
  id: text('id').primaryKey(),
